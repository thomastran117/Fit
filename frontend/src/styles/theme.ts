export const theme = {
  ...
  header: {
    ...
    searchWrapper:
      "group flex h-10 w-full max-w-md items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-3 transition duration-200 focus-within:scale-[1.01] focus-within:border-violet-500 focus-within:bg-white focus-within:ring-4 focus-within:ring-violet-500/10",
    ...
    searchButton:
      "rounded-full bg-violet-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm shadow-violet-600/20 transition duration-200 hover:-translate-y-0.5 hover:bg-violet-700 hover:shadow-md hover:shadow-violet-600/25 active:translate-y-0",
  ...
  buttons: {
    primary:
      "rounded-full bg-violet-600 px-4 py-2 text-sm font-semibold text-white shadow-sm shadow-violet-600/20 transition hover:bg-violet-700",

    secondary:
      "rounded-lg px-3 py-2 text-sm font-semibold text-violet-700 transition hover:bg-violet-50",

    dark:
      "rounded-full bg-slate-950 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-800",
  },
} as const;